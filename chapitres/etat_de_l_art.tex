...
\subsection{les solveurs de contraintes existants}

Tout d'abord, il est important de savoir que le logiciel \iscore{} est codé en langage \cpp{}, nous allons donc préférer des solveurs proposant une interface dans ce langage pour une utilisation finale. À noter que la liste suivante n'est pas exhaustive.%finir pharse mieux
...
Les relations temporelles induisent des contraintes qui sont gérées avec l'aide d'un solveur de contrainte
